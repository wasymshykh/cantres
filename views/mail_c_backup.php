...
<body style="font-family:'Yrsa', serif;">
    ...
    <div style="width:100%; min-width: 500px;background-color: #f3f3f3;padding-bottom: 15px;">
        ...
        <div style="width:100%;display:block;">
            <img src="<?php echo URL; ?>/assets/uploads/<?php echo $apt_img['img_name'];?>" style="width:100%;height: auto;">
        </div>
        ...
        <div style="width: 94%;margin: 15px auto 0 auto;background-color: #fff;padding:15px 0;">
            ...
            <div style="width: 94%;margin: 15px auto;display:table;">
                ...
                <div style="width: 45%; float: left;">
                    <img src="<?php echo URL; ?>/assets/img/map_img.png" style="width:100%;height: auto;display:block;">
                </div>
            </div>
        </div>
        ...
        <div style="width: 94%;margin: 15px auto 0 auto;background-color: #fff;padding:15px 0;">
            ...
            <div style="width: 94%; margin: 15px auto; display:table;">
                <div style="width: 29%; margin: 0 2%; box-sizing: border-box;float:left;">
                    <img src="<?php echo URL; ?>/assets/img/info-icon-1.png" style="width:auto;height: 40px;display:block;margin:0 auto;">
                ...
                <div style="width: 29%; margin: 0 2%; box-sizing: border-box;float:left;">
                    <div style="display:table; margin:0 auto;">
                        <div style="display: inline-block">
                            <img src="<?php echo URL; ?>/assets/img/info-icon-2a.png" style="width:auto;height: 40px;display:block;">
                        </div>
                        <div style="display: inline-block">
                            <img src="<?php echo URL; ?>/assets/img/info-icon-2b.png" style="margin:0 5px; width:auto;height: 40px;display:block;">
                        </div>
                        <div style="display: inline-block">
                            <img src="<?php echo URL; ?>/assets/img/info-icon-2c.png" style="width:auto;height: 40px;display:block;">
                        </div>
                    </div>
                    <h3 style="font-size:12px;font-family:'Oswald',sans-serif;font-weight:700;letter-spacing:1px;color:black;text-align:center;text-transform:uppercase;margin:5px 0 10px 0;">
                        Alquiler
                ...
                <div style="width: 29%; margin: 0 2%; box-sizing: border-box;float:left;">
                    <img src="<?php echo URL; ?>/assets/img/info-icon-3.png" style="width:auto;height: 40px;display:block;margin:0 auto;">
                    <h3 style="font-size:12px;font-family:'Oswald',sans-serif;font-weight:700;letter-spacing:1px;color:black;text-align:center;text-transform:uppercase;margin:5px 0 10px 0;">
                        Taxi
                    </h3>
                    <p style="font-family:serif;font-size:12px;font-weight:400;color:black;margin: 5px 0;line-height:14px;text-align:center;">
            ...
            <div style="width: 94%; margin: 15px auto; display:table;">
                <div style="width: 29%; margin: 0 2%; box-sizing: border-box;float:left;">
                    <img src="<?php echo URL; ?>/assets/img/info-icon-4.png" style="width:auto;height: 40px;display:block;margin:0 auto;">
                    <h3 style="font-size:12px;font-family:'Oswald',sans-serif;font-weight:700;letter-spacing:1px;color:black;text-align:center;text-transform:uppercase;margin:5px 0 10px 0;">
                        Restaurantes
                    </h3>
                    <p style="font-family:serif;font-size:12px;font-weight:400;color:black;margin: 5px 0;line-height:14px;text-align:center;">
                ...
                <div style="width: 29%; margin: 0 2%; box-sizing: border-box;float:left;">
                    <img src="<?php echo URL; ?>/assets/img/info-icon-5.png" style="width:auto;height: 40px;display:block;margin:0 auto;">
                    <h3 style="font-size:12px;font-family:'Oswald',sans-serif;font-weight:700;letter-spacing:1px;color:black;text-align:center;text-transform:uppercase;margin:5px 0 10px 0;">
                        LQUILER BARCO
                    </h3>
                    <p style="font-family:serif;font-size:12px;font-weight:400;color:black;margin: 5px 0;line-height:14px;text-align:center;">
                ...
                <div style="width: 29%; margin: 0 2%; box-sizing: border-box;float:left;">
                    <img src="<?php echo URL; ?>/assets/img/info-icon-6.png" style="width:auto;height: 40px;display:block;margin:0 auto;">
                    <h3 style="font-size:12px;font-family:'Oswald',sans-serif;font-weight:700;letter-spacing:1px;color:black;text-align:center;text-transform:uppercase;margin:5px 0 10px 0;">
                        Playas
                    </h3>
                    <p style="font-family:serif;font-size:12px;font-weight:400;color:black;margin: 5px 0;line-height:14px;text-align:center;">
