    ...
    <div class="apt-prices">
        ...
        <div class="apt-prices-boxes">
            <div class="apt-field">
                ...
                <input type="text" name="p_1_a" id="tbajaa" value="<?=isset($_POST['p_1_a'])? $_POST['p_1_a']:$apartment['p_1_a']?>">
            </div>
            <div class="apt-field">
                <label for="tmediaa">T.Media</label>
                <input type="text" name="p_2_a" id="tmediaa" value="<?=isset($_POST['p_2_a'])? $_POST['p_2_a']:$apartment['p_2_a']?>">
            </div>
            <div class="apt-field">
                <label for="taltaa">T.Alta</label>
                <input type="text" name="p_3_a" id="taltaa" value="<?=isset($_POST['p_3_a'])? $_POST['p_3_a']:$apartment['p_3_a']?>">
            </div>
            <div class="apt-field">
                <label for="tprimea">T.Prime</label>
                <input type="text" name="p_4_a" id="tprimea" value="<?=isset($_POST['p_4_a'])? $_POST['p_4_a']:$apartment['p_4_a']?>">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="apt-session-setter">
            ...
            <div class="apt-session-date-select apt-session-tbaja isActive">
                <div class="apt-session-selector">
                    <input type="text" id="dateOne" name="s_1_date" value="<?=isset($_POST['s_1_date'])?$_POST['s_1_date']:dateUser($apartment['s_1_start']).' to '. dateUser($apartment['s_1_end'])?>">
            ...
            <div class="apt-session-date-select apt-session-tmedia">
                <div class="apt-session-selector">
                    <input type="text" id="dateTwo" name="s_2_date" value="<?=isset($_POST['s_2_date'])?$_POST['s_2_date']:dateUser($apartment['s_2_start']).' to '. dateUser($apartment['s_2_end'])?>">
            ...
            <div class="apt-session-date-select apt-session-talta">
                <div class="apt-session-selector">
                    <input type="text" id="dateThree" name="s_3_date" value="<?=isset($_POST['s_3_date'])?$_POST['s_3_date']:dateUser($apartment['s_3_start']).' to '. dateUser($apartment['s_3_end'])?>">
            ...
            <div class="apt-session-date-select apt-session-tprime">
                <div class="apt-session-selector">
                    <input type="text" id="dateFour" name="s_4_date" value="<?=isset($_POST['s_4_date'])?$_POST['s_4_date']:dateUser($apartment['s_4_start']).' to '. dateUser($apartment['s_4_end'])?>">
